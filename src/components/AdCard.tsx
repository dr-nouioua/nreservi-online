    ...
    >
      ...
      <span className="flex items-start justify-between gap-3 p-4">
        <span className="min-w-0">
          <span className="block font-semibold text-stone-900 dark:text-stone-100">{ad.title}</span>
          {ad.body && <span className="mt-1 block text-sm text-stone-500 dark:text-stone-400">{ad.body}</span>}
        </span>
        {ad.linkUrl && (

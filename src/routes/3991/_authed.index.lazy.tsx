...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  spa: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300',
  football_pitch: 'bg-lime-100 text-lime-700 dark:bg-lime-500/15 dark:text-lime-300',
  car_rental: 'bg-slate-100 text-slate-700 dark:bg-slate-500/15 dark:text-slate-300',
  barbershop: 'bg-violet-100 text-violet-700 dark:bg-violet-500/15 dark:text-violet-300',
  doctor: 'bg-[#069494]/10 text-[#069494] dark:bg-[#069494]/15 dark:text-teal-300',
}

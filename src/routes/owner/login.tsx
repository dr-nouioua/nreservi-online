  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-stone-100 px-4 py-12">
      ...
      <div className="w-full max-w-sm bg-white rounded-xl border border-stone-200 p-8">
        <h1 className="text-xl font-bold text-stone-900">Espace professionnel</h1>
        ...
        <form onSubmit={submit} className="mt-6 space-y-3">
          ...
          <div>
            <label className="text-xs text-stone-500">Mot de passe</label>
      ...
      <a href="/" className="mt-6 text-sm text-stone-500 hover:text-stone-900">

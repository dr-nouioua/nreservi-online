  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 w-full max-w-2xl mx-auto px-4 py-12">
        ...
        <p className="text-stone-500 mt-1">Retrouvez vos réservations avec le numéro de téléphone utilisé lors de la réservation.</p>
          ...
          <div className="mt-8 space-y-4">
            {data.customer && (
              <div className="flex items-center justify-between text-sm bg-white border border-stone-200 rounded-lg p-4">
                <span className="text-stone-600">Notifications WhatsApp</span>
                <button
            ...
            {data.reservations.length === 0 && (
              <p className="text-stone-500 text-sm text-center py-8">Aucune réservation trouvée pour ce numéro.</p>
            )}
              ...
              <div key={reservation.id} className="bg-white border border-stone-200 rounded-lg p-4">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <span className="inline-block mt-1 text-xs px-2 py-0.5 rounded-full bg-stone-100 text-stone-600">

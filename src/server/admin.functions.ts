...
const DEFAULT_PACKAGES = [
  ...
  },
  {
    name: "12 mois",
    price: "25 000 DA",
    period: "12 mois + 2 offerts",
    features: [
      "Toutes les fonctionnalités de la formule 6 mois",
      "Réservation en ligne temps réel",
      "Confirmation & rappels WhatsApp",
  ...
  },
  {
    ...
    price: "5 000 DA+",
    period: "par mois",
    features: ["Carte mise en avant sur les pages", "Carrousel publicitaire", "Audience ciblée par catégorie"],
    kind: "ads",
    popular: false,
  },
];
